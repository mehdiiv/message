...
class ApiTest(TestCase):
  ...
  def test_api_create_user_view(self):
  ...
  def test_api_create_user_view_invalid_data_invalid_json(self):
  ...
  def test_api_create_user_view_invalid_data_null_mail(self):
  ...
  def test_api_create_user_view_invalid_data_exist_mail(self):
  ...
  def test_api_create_user_view_invalid_data_exist_empty_srting(self):
    response = self.client.post(reverse('users'), json.dumps({"email": '' }), **self.json_request)
    self.assertEqual(response.status_code, 422)
    self.assertEqual(response.json()['error_message'], 'email cannot be empty')

  def test_api_create_user_view_invalid_data_inccorect_mail(self):
  ...
  def test_api_users_list_view(self):
